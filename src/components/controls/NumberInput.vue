    ...
    <div class="flex flex-col gap-3">
      ...
      <div class="relative flex items-center gap-3">
        <div class="relative inline-block min-w-18">
          <span
            ref="mirrorRef"
            class="invisible inter-500 border absolute whitespace-pre pl-2 pr-[16.5px] py-[11px] text-[18px] leading-none"
          >
            {{ maskedValue || "0" }}
          </span>
          <input
            ...
            type="text"
            inputmode="numeric"
            class="text-(--c-dark) min-w-18 pl-2 pr-[16.5px] py-[11px] h-[44px] text-[18px] leading-none inter-500 border border-gray-300 transition-colors rounded outline-none focus-within:border-(--c-primary-light) caret-(--c-primary-light)"
            placeholder="0"
            @focus="handleFocus"
            @blur="handleBlur"
          />
